...
import com.scottruth.timeoffandroid.BuildConfig;
import com.scottruth.timeoffandroid.BuildType;
...
public class OkHttpClientFactory {
    ...
    public static OkHttpClient createPicassoOkHttpClient() {
        ...
        File httpCacheDir = new File(TimeOffApplication.getContext().getExternalCacheDir(), "cache");

...
public class ServiceErrorHandler {
  ...
  private final Consumer<Throwable> serviceErrorHandler = t -> {
    ...
    information.put(CRASHLYTICS_KEY_URL, ServiceHelper.getUrl(serviceExceptionWithMessage.getResponse().raw()));
    information.put(CRASHLYTICS_KEY_STATUS_CODE, String.valueOf(serviceExceptionWithMessage.getCode()));
    information.put(CRASHLYTICS_KEY_RESPONSE_HEADERS, serviceExceptionWithMessage.getResponse().headers().toString());
    information.put(CRASHLYTICS_KEY_RESPONSE_BODY, serviceExceptionWithMessage.getErrorBody());

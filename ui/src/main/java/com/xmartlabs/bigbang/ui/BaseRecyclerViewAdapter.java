...
public abstract class BaseRecyclerViewAdapter<T, VH extends RecyclerView.ViewHolder>
  ...
  /**
   * Sets the items data for the recycler view and notifying any registered observers that the data
   * set has
   * changed.
   *
  ...
  /**
   * Adds items to the data for the recycler view and notifies any registered observers that the
   * data set has
   * changed.
   *
   * @param items the items that will be the data for the recycler view

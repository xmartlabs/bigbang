...
```groovy
compile 'com.xmartlabs.bigbang:core:0.1.53'
```
...
```groovy
compile 'com.xmartlabs.bigbang:dbflow:0.1.53'
compile 'com.xmartlabs.bigbang:log-crashlytics:0.1.53'
compile 'com.xmartlabs.bigbang:retrofit:0.1.53'
compile 'com.xmartlabs.bigbang:ui:0.1.53'
```

...
import com.xmartlabs.base.core.helper.gsonadapters.LocalDateTimeCustomFormatterAdapter;
...
public class LocalDateTimeCustomFormatterAdapterTest {
  ...
  private static final String DEFAULT_DATE_STRING = dateTimeFormatter.format(DEFAULT_DATE.atOffset(ZoneOffset.UTC)
      .toInstant());
  private final LocalDateTimeCustomFormatterAdapter adapter = new LocalDateTimeCustomFormatterAdapter(dateTimeFormatter);

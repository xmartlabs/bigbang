...
abstract class EntityController<Id, E : EntityWithId<Id>, in Condition, out S : EntityServiceProvider<Id, E>,
   ...
   */
  @CheckResult
  protected open fun getEntity(serviceCall: (Id) -> Single<E>, id: Id) =
   ...
   */
  @CheckResult
  protected open fun getEntityFromDbIfPresentOrGetFromService(serviceCall: (Id) -> Single<E>, id: Id) =
      entityDao.getEntity(id)
          .switchIfEmpty(getServiceEntity(serviceCall, id).toMaybe()).toSingle()
   ...
   */
  @CheckResult
  protected open fun getServiceEntity(serviceCall: (Id) -> Single<E>, id: Id) =
      serviceCall(id).applyIoSchedulers()
          .doOnSuccess { entityDao.updateEntity(it) }
   ...
   */
  @CheckResult
  protected open fun deleteEntity(serviceCall: (Id) -> Completable, entityId: Id) =
   ...
   */
  @CheckResult
  protected open fun deleteEntity(serviceCall: (Id) -> Completable, entity: E) =

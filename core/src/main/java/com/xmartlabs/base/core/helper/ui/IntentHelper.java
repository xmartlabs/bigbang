...
public class IntentHelper {
   ...
   */
  public static boolean canDeviceHandleIntent(@NonNull Context context, @NonNull Intent intent) {
   ...
   */
  public static boolean deviceHasCameraAbility(@NonNull Context context) {
   ...
   */
  @NonNull
  private static String getString(@NonNull Context context, @StringRes int messageRes) {
